...
//        users.filter { $0.role == .librarian && ($0.is_active != nil) } // Assuming isActive logic is still needed externally or added later
//    }
//    var activeMembers: [User] {
//        users.filter { $0.role == .member && ($0.is_active != nil) } // Assuming isActive logic is still needed externally or added later
//    }
//
...
//         vm.users = [
//            User(id: UUID(), email: "librarian1@example.com", role: .librarian, name: "Alice The Librarian", is_active: true, library_id: "MAINLIB", profileImage: UIImage(systemName: "person.crop.circle.fill")?.jpegData(compressionQuality: 0.8)),
//            User(id: UUID(), email: "member1@example.com", role: .member, name: "Bob The Member",is_active: true, library_id: "MAINLIB"),
//            User(id: UUID(), email: "librarian2@example.com", role: .librarian, name: "Charles Staff",is_active: true, library_id: "BRANCHLIB"),
//            User(id: UUID(), email: "member2@example.com", role: .member, name: "Diana User",is_active: true, library_id: "MAINLIB", profileImage: UIImage(systemName: "person.crop.circle")?.jpegData(compressionQuality: 0.8))
//         ]
//         return vm
//     }
//
